package http2.utils {
	...
	public class HPACK {
		...
		//Huffman Coding Table, aligned to LSB.
		//Each code's index matches its ASCII representation (e.g. 0x1ff8 is at index 0 = ASCII symbol 0)		
		public static const HCT_LSB:Vector.<uint> = new <uint>[
		...
		0x6a, 0x6b, 0x6c, 0x6d, 0x6e, 0x6f, 0x70, 0x71, 0x72, 0xfc,
		0x73, 0xfd, 0x1ffb, 0x7fff0, 0x1ffc, 0x3ffc, 0x7ffd, 0x3, 0x23, 0x4,
		...
		public function HPACK() {
			
		}
		
		 private function toBinary(inputNumber:uint):String {                        			
			var returnString:String=new String();
			var currentDigit:String;
			//32 bits
			for (var count:uint=0; count<32; count++) {                                          
		...
		private function fromBinary(inputString:String):uint {
